...
%token HEADER MAIN LB RB LCB RCB SC COMA IF ELSE VAR ET EQ GT LT GTE LTE NE AND OR NOT PLUS MINUS MUL DIV MOD EXP UPLUS UMINUS
...
PROGRAM_STATEMENTS : PROGRAM_STATEMENT PROGRAM_STATEMENTS 
			...
			| IF LOGICAL_EXPN LCB IF_BODY RCB
			| IF LOGICAL_EXPN LCB IF_BODY RCB ELSE LCB IF_BODY RCB
			| PROGRAM_STATEMENT

IF_BODY		: /*Epsilon*/ | DECLARATION_STATEMENTS IF_BODY | PROGRAM_STATEMENTS IF_BODY

LOGICAL_EXPN	: LB NOT LB LOGICAL_EXPN1 RB RB | LB LOGICAL_EXPN1 RB
